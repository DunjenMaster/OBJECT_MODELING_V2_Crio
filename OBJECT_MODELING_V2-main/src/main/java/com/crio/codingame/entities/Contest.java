...
public class Contest extends BaseEntity{
    ...
    private void validateQuestionList(List<Question> qList, Level contestLevel) throws InvalidContestException {
        if (qList.isEmpty()) {
            throw new InvalidContestException("Questions list is empty.");
        }
        ...
        for (Question question : qList) {
            if (!question.getLevel().equals(contestLevel)) {
                throw new InvalidContestException("Questions have different levels than the contest level.");
            }
    
            // if (!question.getLevel().equals(firstQuestionLevel)) {
            //     throw new InvalidContestException("Questions have different levels among themselves.");
    }
}
